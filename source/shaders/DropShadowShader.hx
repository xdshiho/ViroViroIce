...
class DropShadowShader extends FlxShader
{
  ...
  function set_attachedSprite(spr:FlxSprite):FlxSprite
  {
    ...
    */
    ...
    // i think useRenderTexture only exists in FunkinCrew forks of the haxelib so i'm commenting this
    // i'll do something about it if it doesn't work properly - emilly
    /*
  ...
  @:glFragmentSource('
    ...
    ')
  public function new(?attachedSprite:FlxSprite)
  {
    super();
